...
See the [RSP repo](https://github.com/cabutchei/rsp-wtp-server) for further details about RSP.
See the [VSCode server connector repo](https://github.com/cabutchei/rsp-wtp-server-connector) for more details about the server connector.

## Installing

```sh
npm i rsp-wtp-server-connector-api
```
